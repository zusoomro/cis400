...
const eventsOfTheDay: Event[] = [
  {
    ...
    start_time: new Date("2021-11-13T09:00:33.44-05:00"),
    end_time: new Date("2021-11-13T10:30:33.44-05:00"),
  ...
  } as Event,
  {
    ...
    ownerId: 1,
    formattedAddress: "3934 Pine St, Philadelphia, PA 19104, USA",
    start_time: new Date("2021-11-13T12:34:33.44-05:00"),
    end_time: new Date("2021-11-13T13:05:33.44-05:00"),
    notes: "Bike ride time.",
    name: "Go for a bike ride",
    lat: 39.95034599999999,
    lng: -75.201981,
  ...
  } as Event,
  {
    ...
    ownerId: 1,
    formattedAddress: "3934 Pine St, Philadelphia, PA 19104, USA",
    start_time: new Date("2021-11-13T15:10:33.44-05:00"),
    end_time: new Date("2021-11-13T17:40:33.44-05:00"),
    notes: "Bike ride time.",
    name: "Go for a bike ride",
    lat: 39.95034599999999,
    lng: -75.201981,
...
const proposedEvent1: Event = {
  ...
  ownerId: 1,
  formattedAddress: "3934 Pine St, Philadelphia, PA 19104, USA",
  start_time: new Date("2021-11-13T13:00:00.44-05:00"),
  end_time: new Date("2021-11-13T14:00:00.44-05:00"),
  notes: "Bike ride time.",
  name: "Go for a bike ride",
  lat: 39.95034599999999,
  lng: -75.201981,
...
const proposedEvent2: Event = {
  ...
  ownerId: 1,
  formattedAddress: "3934 Pine St, Philadelphia, PA 19104, USA",
  start_time: new Date("2021-11-13T10:00:00.44-05:00"),
  end_time: new Date("2021-11-13T11:30:00.44-05:00"),
  notes: "Bike ride time.",
  name: "Go for a bike ride",
  lat: 39.95034599999999,
  lng: -75.201981,
...
const proposedEvent3: Event = {
  ...
  formattedAddress: "3934 Pine St, Philadelphia, PA 19104, USA",
  start_time: new Date("2021-11-13T10:00:00.44-05:00"),
  end_time: new Date("2021-11-13T12:30:00.44-05:00"),
  notes: "Bike ride time.",
  name: "Go for a bike ride",
  lat: 39.95034599999999,
  lng: -75.201981,
